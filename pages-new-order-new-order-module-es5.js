(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-new-order-new-order-module"], {
    ...
    function Rpoh(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "NewOrderModule", function () {
      ...
      var _new_order_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./new-order.component */
      "lC0+");
      /* harmony import */


      var app_theme_shared_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! app/@theme/shared.module */
      "yzeJ");
      /* harmony import */


      var _new_order_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./new-order-routing.module */
      "kk3p");

      var NewOrderModule = function NewOrderModule() {
        _classCallCheck(this, NewOrderModule);
      };

      NewOrderModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NewOrderModule
      });
      NewOrderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function NewOrderModule_Factory(t) {
          return new (t || NewOrderModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _new_order_routing_module__WEBPACK_IMPORTED_MODULE_4__["NewOrderRoutingModule"], app_theme_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewOrderModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewOrderModule, [{
    ...
    function kk3p(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "NewOrderRoutingModule", function () {
        return NewOrderRoutingModule;
      });
      /* harmony import */
      ...
      var NewOrderRoutingModule = function NewOrderRoutingModule() {
        _classCallCheck(this, NewOrderRoutingModule);
      };

      NewOrderRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NewOrderRoutingModule
      });
      NewOrderRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function NewOrderRoutingModule_Factory(t) {
          return new (t || NewOrderRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NewOrderRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewOrderRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
    ...
    /***/
    function lC0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var app_theme_services_order_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      function NewOrderComponent_ng_template_9_div_0_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var row_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().row;
      ...
      function NewOrderComponent_ng_template_9_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NewOrderComponent_ng_template_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var NewOrderComponent = /*#__PURE__*/function () {
        function NewOrderComponent(orderService, commonService) {
        ...
        _createClass(NewOrderComponent, [{
          ...
          key: "getAllNewOrderList",
          value: function getAllNewOrderList() {
            var _this = this;

            this.orderService.getNewOrders().subscribe(function (data) {
              if (data['success']) {
                _this.newOrderList = data['data'];
              } else _this.newOrderList = [];
            }, function (error) {
              _this.newOrderList = [];
            });
          }
      ...
      NewOrderComponent.ɵfac = function NewOrderComponent_Factory(t) {
        return new (t || NewOrderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_theme_services_order_service__WEBPACK_IMPORTED_MODULE_2__["OrderService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_theme_services_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"]));
      };

      NewOrderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: NewOrderComponent,
        selectors: [["ngx-new-order"]],
        decls: 10,
        vars: 4,
        consts: [[1, "nb-style"], [1, "material", 3, "rows", "ngClass", "headerHeight", "footerHeight"], ["name", "Party name", "prop", "partyName"], ["name", "Type", "prop", "productType"], ["name", "Quality", "prop", "productQuality"], ["name", "Capacity", "prop", "productCapacity"], ["name", "Package-size", "prop", "productPackageSize"], ["name", "Quantity", "prop", "quantity"], ["ngx-datatable-cell-template", ""], ["style", "color: red;", 4, "ngIf"], [4, "ngIf"], [2, "color", "red"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewOrderComponent, [{
          ...
          return [{
            type: app_theme_services_order_service__WEBPACK_IMPORTED_MODULE_2__["OrderService"]
          }, {
...
//# sourceMappingURL=pages-new-order-new-order-module-es5.js.map